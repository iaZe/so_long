...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/04 23:43:53 by dantavar          #+#    #+#             */
/*   Updated: 2022/08/02 23:21:47 by dantavar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_map2(t_game *game, char *whole_chars)
{
	...
	game->map_height = (game->line_number) * 40;
...
int	init_struc(t_game *game)
{
	...
	game->mlx.mlx_win = mlx_new_window(game->mlx.mlx,
			game->map_width, game->map_height, "SO_LONG_POKEMON");
